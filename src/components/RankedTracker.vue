<template>
  <Button @click="showTracker = !showTracker" :text="showTracker ? 'Hidde Stats': 'Show Stats' "/>
  <div class="wrapper" v-if="showTracker">
    <form @submit.prevent >
    ...
    <div class="small-container">
      <input
        class="total-trophies"
        id="total-trophies"
        v-model.number="totalTrophies"
      />
      <img
...
export default {
  ...
  async created() {
    this.wins = localStorage.getItem("wins")
      ...
      : 0;
    this.loses = localStorage.getItem("loses")
      ? parseInt(localStorage.getItem("loses"))
      : 0;
    this.draws = localStorage.getItem("draws")
      ? parseInt(localStorage.getItem("draws"))
      : 0;
    this.totalTrophies = localStorage.getItem("trophies")
      ? parseInt(localStorage.getItem("trophies"))
      : 0;
  },
};
</script>
